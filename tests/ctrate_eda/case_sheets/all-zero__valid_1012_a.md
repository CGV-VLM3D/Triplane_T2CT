# Case sheet — `valid_1012_a` (recon 1) — group: **all-zero**
...
| primary file | `valid_1012_a_1.nii.gz` |
| age / sex | 35Y / F |
| manufacturer / model | Philips / Brilliance Big Bore |
| kernel | A |
| shape (RxCxSlices) | 512x512x203 |
| voxel spacing (x,y,z mm) | 0.57422x0.57422x1.5 |
| intensity min/med/max (HU) | -1024 / -858.0 / 1766 |
| no_chest excluded set | no |

## Montage (axial / coronal / sagittal x lung / mediastinal)

![montage](../figures/montages/all-zero__valid_1012_a.png)
...
- [ ] Verify montage orientation & that lung fields / mediastinum are visible (`all-zero__valid_1012_a.png`).
- [ ] Verify spacing/shape are plausible for a chest CT (spacing 0.57422x0.57422x1.5, shape 512x512x203).
